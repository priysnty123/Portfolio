...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/priyanshu-tiwari-2522aa216?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@priyanshu",
    icon: Github,
    url: "https://github.com/priysnty123", // Fixed typo: "ttps" to "https"
    color: "#ffffff",
